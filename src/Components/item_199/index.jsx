...
import "./style.css";
import item_199 from "../../data/item_199.json";
import { Link } from "react-router-dom";

const Item_199 = () => {
  const [products, setProducts] = useState(item_199);
  ...
  const handleFilterClick = () => {
    if (!isFiltered) {
      const filtered = item_199.filter((item) =>
        item.title.toLowerCase().includes("item_199")
      );
      setProducts(filtered);
    } else {
      setProducts(item_199);
    }
  ...
  return (
    <>
      ...
      <div className="container">
        <div className="header">Under 199 </div>
